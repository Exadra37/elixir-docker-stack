...
>      `elixir`, `mix`, `iex`, `erl` or `rebar` you are not using the ones you
>      already have installed, instead you are running the **Elixir Docker Stack** ones.
>
...
>   alternative see the next section to use the custom command `elixir observer`.
